...
update_p_nl = t.spacing**2 * vel0**2 / b * \
    (g1_tilde(b1m2e * g1(p0, phi0, theta0), phi0, theta0) +
     g2_tilde(b1m2e * g2(p0, phi0, theta0), phi0, theta0) +
     g3_tilde(b1mfe2 * g3(p0, phi0, theta0) +
              bfes1me2 * g3(m0, phi0, theta0), phi0, theta0)) + \
...
update_m_nl = t.spacing**2 * vel0**2 / b * \
    (g1_tilde(b1mf * g1(m0, phi0, theta0), phi0, theta0) +
     g2_tilde(b1mf * g2(m0, phi0, theta0), phi0, theta0) +
     g3_tilde(b1mfpfe2 * g3(m0, phi0, theta0) +
              bfes1me2 * g3(p0, phi0, theta0), phi0, theta0)) + \
